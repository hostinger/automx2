...
from automx2.views import autodiscoverv2
...
MSOFTV2_CONFIG_ROUTE = '/autodiscover/autodiscover.json'
...
app.add_url_rule(MSOFTV2_CONFIG_ROUTE, view_func=autodiscoverv2.OutlookView.as_view('msoftv2'), methods=['GET'])
_proxy_fix()
